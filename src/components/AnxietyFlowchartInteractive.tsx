...
const AnxietyFlowchartInteractive: React.FC<Props> = ({ patient, initialStep, initialHistory, initialAnswers, onUpdate, onComplete, onBack, onOpenReport, onSwitchFlowchart }) => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50/50 pb-12">
    ...
    <main className="mx-auto mt-7 max-w-6xl px-4 sm:px-6">
      ...
      <motion.section id="anxiety-current-conduct" key={stage} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/50 sm:p-7">
        ...
        {stage === 'ansiedade_medicamentosa' && <div className="mt-5 flex justify-end"><InlineClinicalCopyButton targetId="anxiety-current-conduct" /></div>}
