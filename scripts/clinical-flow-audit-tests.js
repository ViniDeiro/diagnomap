...
assert.match(flowSource, /Salbutamol spray 100 mcg\/dose: 4–8 jatos com espaçador a cada 20 minutos durante a primeira hora/, 'Bombinha da asma deve informar apresentação, quantidade de jatos e frequência')
...
assert.match(flowSource, /data-asthma-copy-nebulization/, 'Tela de broncodilatação da asma deve ter botão de copiar prescrição sugerida')
