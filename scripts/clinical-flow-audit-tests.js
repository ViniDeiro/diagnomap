...
assert.match(flowSource, /fenoterol 5 mg\/mL, 10–20 gotas[\s\S]*ipratrópio 0,25 mg\/mL, 40 gotas[\s\S]*volume de 5 mL[\s\S]*cada 20 minutos, por três doses/, 'Nebulização da asma deve informar preparo e repetição completos')
